          ...
          {currentStep.key === 'settings' ? (
            ...
            <>
              ...
              {botUsername && isConnected && (
                <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900 rounded-lg p-4 text-center space-y-3">
                ...
                <>
                  <ol className="space-y-2.5 text-sm text-slate-700 dark:text-slate-200 list-none">
                    ...
                    <li className="flex gap-2.5">
                      ...
                      <span>
                        Tap the group name â†’ <b>Add Members</b> â†’ search{' '}
                        <span className="font-mono font-semibold text-sky-700 dark:text-sky-400">@{botUsername}</span> â†’ tap it to add.
                      </span>
                    </li>
                    <li className="flex gap-2.5">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 bg-slate-900 dark:bg-black rounded-lg px-4 py-3 font-mono text-sky-400 text-sm font-semibold tracking-wide text-center border border-slate-700">
                    ...
                    <button
                      ...
                      className="w-11 h-11 shrink-0 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-40 flex items-center justify-center cursor-pointer"
