          ...
          {canSwitchProperties && (properties.length > 1 || onSwitchProperty) ? (
            ...
            >
              <div className="px-3.5 py-2 text-2xs font-semibold text-gray-500 dark:text-gray-400 bg-gray-50/80 dark:bg-gray-800/80 flex items-center justify-between">
                ...
                {properties.length > 0 && (
                  <span className="text-3xs font-semibold bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-300 px-1.5 py-0.5 rounded">
              ...
              <div className="header__dropdown notifications-popover-dropdown fixed left-2 right-2 top-[calc(4rem+env(safe-area-inset-top,0px))] max-sm:w-auto sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-96 bg-blue-100 dark:bg-blue-900/60 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 py-2 z-50 animate-in fade-in slide-in-from-top-2">
                <div className="header__dropdown-header px-4 pt-2 pb-2.5 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between gap-2">
                  ...
                  <span className="flex items-center gap-2 shrink-0">
                    <span className="header__dropdown-count text-[10px] bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-300 px-2 py-0.5 rounded-md">
                      {totalCount} updates
                    </span>
                    <button
                      type="button"
                      ...
                      <div className="header__guests space-y-1.5">
                        ...
                        {tomorrowGuests.map((guest) => (
                          ...
                          >
                            ...
                            <span className="header__guest-badge header__guest-badge--tomorrow text-[9px] font-semibold px-2 py-0.5 rounded-md shrink-0 bg-purple-100 text-purple-800 dark:bg-purple-900/60 dark:text-purple-300">
