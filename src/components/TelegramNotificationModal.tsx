          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span className={`px-2 py-0.5 rounded-md text-2xs font-bold uppercase tracking-wider border ${
              ...
              <TabItem
                ...
                title={
                  <span className="inline-flex items-center gap-1.5">
                    <span>{cat}</span>
                    {count > 0 && (
                      <span className="inline-flex items-center justify-center px-1.5 py-0.5 text-2xs font-semibold rounded-md bg-sky-100 text-sky-800 dark:bg-sky-900/60 dark:text-sky-300 border border-sky-200 dark:border-sky-800">
                        {count}
                      </span>
                    )}
                  </span>
