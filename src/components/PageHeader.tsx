...
export const PageHeader: React.FC<PageHeaderProps> = ({ title, subtitle, children, forceRow, inlineActions }) => (
  ...
  <div className={`gen_page_head px-4 sm:px-0 flex ${forceRow ? 'flex-row items-center' : 'flex-col items-start sm:flex-row sm:items-center'} justify-between gap-3 page-header`}>
