  ...
  return (
    <>
      ...
      <Drawer
        ...
        position="right"
        className="z-58 w-full sm:w-120 p-0 bg-white dark:bg-gray-800 shadow-2xl flex flex-col justify-between property-address-bar__modal"
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 property-address-bar__modal-title">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 property-address-bar__modal-body">
          <Input
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-2 bg-gray-50 dark:bg-gray-850 property-address-bar__modal-footer">
          <Button
            variant="primary"
            size="sm"
            onClick={handleSave}
