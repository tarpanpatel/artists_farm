  ...
  useEffect(() => {
    ...
    rangepicker.datepickers.forEach((dp) => {
      ...
      if (pickerEl && !pickerEl.querySelector('.datepicker-cancel-btn')) {
        ...
        cancelBtn.setAttribute('aria-label', 'Close calendar');
        cancelBtn.className = 'datepicker-cancel-btn absolute top-2 right-2 z-20 flex items-center justify-center w-7 h-7 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-700 transition-colors cursor-pointer';
