  ...
  return (
    <div className="license-management space-y-6">
      ...
      {loading ? (
        ...
        <div className="license-management__empty flex flex-col items-center justify-center py-16 px-6 text-center bg-white dark:bg-slate-800 rounded-none sm:rounded-lg border-x-0 sm:border border-y sm:border-y border-dashed border-slate-300 dark:border-slate-700">
