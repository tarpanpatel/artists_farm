...
function saveRateRule($pdo, $propertyId) {
    try {
        ...
        //
        // Optional by design. The channel-manager integration lives on its own
        // branch and may not be present at all - an unconditional require here
        // made saving ANY rate rule fatal on a checkout without php/channex/,
        // which is exactly what happened when this hook was merged ahead of
        // the code it depends on. Rate rules are a standalone product feature;
        // they must never fail because an optional distribution integration
        // isn't installed.
